...
import { getChannleDetails } from '../../redux/actions/channel.action'
...
const ChannelScreen = () => {
  ...
  return (
    ...
    <Container>
        <Row className='mt-2'>
            {
                !loading ? videos?.map(video=><Col md={4} lg={3}><Video video={video} channelScreen/></Col>):[...Array(15)].map(()=><Col md={4} lg={3}><SkeletonTheme color='#343a40' highlightColor='#3c4147'><Skeleton width="100%" height="140px"/></SkeletonTheme></Col>)
            }
        </Row>
    </Container>
    </>
